...
uint RPEP::MakeServerHello(DArray& outBuff,ushort ver,ulong MaxPaquetSize,ulong CompresAlgCount,ulong* CompresAlg){
    ...
    *((ushort*)&sHello->Version) = ver;
    ...
    MakePacket(outBuff,RPEP_HEADER::Operation::ServerHandshake,0,buff,sizeof(RPEP_SERVER_HANDSHAKE)+CompresAlgCount*sizeof(RPEP_SERVER_HANDSHAKE::SupportedCompressionAlgm));
